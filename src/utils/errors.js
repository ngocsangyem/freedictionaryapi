module.exports = {
	...
	NoPronunciationFound: class NoPronunciation extends Error {
		constructor(additionalInfo = {}) {
			super();

			this.name = 'NoPronunciation';
			this.title = 'No Pronunciation Found';
			this.message =
				"Sorry pal, we couldn't find pronunciation for the word you were looking for.";
			this.resolution =
				'You can try the search again at later time or head to the web instead.';
			this.additionalInfo = additionalInfo;
			this.requestType = 'notFound';
